  ...
  return (
    <div className="grid min-h-screen grid-cols-[240px_1fr] bg-slate-50">
      <aside className="flex flex-col border-r border-slate-200 bg-white p-4 shadow-sm">
        ...
        <button
          onClick={logout}
          className="mt-4 w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:bg-slate-50"
        >
          Cerrar sesión
        </button>
      </aside>
