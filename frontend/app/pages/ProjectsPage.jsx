        ...
        <form onSubmit={createProject} className="mt-4 flex max-w-lg flex-col gap-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-slate-800 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full max-w-xs rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-slate-800 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            >
