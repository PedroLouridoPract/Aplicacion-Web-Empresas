...
-- CreateIndex
CREATE INDEX "Task_companyId_projectId_status_orderIndex_idx" ON "Task"("companyId", "projectId", "status", "orderIndex");

-- CreateIndex
CREATE INDEX "Task_companyId_assigneeId_dueDate_idx" ON "Task"("companyId", "assigneeId", "dueDate");

-- CreateIndex
CREATE INDEX "Comment_companyId_taskId_idx" ON "Comment"("companyId", "taskId");
